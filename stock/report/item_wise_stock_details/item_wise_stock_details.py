...
def get_columns():
	return ["Item Code:Link/Item:140", "Warehouse:Link/Warehouse:140", 'Quantity::80']
...
def get_data():
	...
	if webnotes.session.user != 'Administrator':
		...
		cond = "and 1 = 1"
	return webnotes.conn.sql(""" select item_code,warehouse,count(warehouse) from `tabSerial No` 
